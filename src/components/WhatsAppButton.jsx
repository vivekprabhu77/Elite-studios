...
export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-[999] flex items-center gap-3 select-none pointer-events-none group">
      {/* Premium Dark Glass Tooltip Pill - completely to the left of the button */}
      ...
      {/* Main Luxury WhatsApp Icon Button - ONLY this circle is clickable */}
      <a
        href={getWhatsAppProjectUrl()}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp"
        className="pointer-events-auto relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_12px_40px_rgba(37,211,102,0.7)] transition-all duration-300 hover:scale-105 active:scale-95 ring-1 ring-white/20 shrink-0"
      >
        <svg
